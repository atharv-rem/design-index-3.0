...
export default function ToolsGrid({ category, initialTools }: ToolsGridProps) {
  ...
  return (
    <section className="mt-5 w-full">
      <p className="mb-2 font-rethink font-bold text-[11px] uppercase tracking-[0.1rem] theme-text-soft">Filter by pricing</p>
        ...
        {filters.map((filter) => {
          ...
          return (
            <button
              ...
              className={`rounded-[10px] border px-3 py-1.5 font-rethink font-bold text-xs transition-colors shadow-hairline ${
                active
