  ...
  return (
    <AutocompletePrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "shadow-everywhere relative flex max-h-full min-w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) rounded-lg border bg-popover not-dark:bg-clip-padding transition-[scale,opacity]",
            className,
          )}
        >
